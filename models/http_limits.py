...
def _apply_limits():
    """Apply the current limits to odoo.http / werkzeug."""
    try:
    ...
    # Fallback / additional: patch werkzeug Request class directly
    try:
        ...
        try:
            # Werkzeug < 2.0 uses BaseRequest
            from werkzeug.wrappers import BaseRequest
            BaseRequest.max_content_length = _max_content_length
            BaseRequest.max_form_memory_size = _max_form_memory_size
        except Exception:
